...
export const env = Object.freeze({
  ...
  // exe.dev: also include ALLOWED_ORIGINS (legacy env var for reverse-proxy access)
  trustedOrigins: [...asCsv(process.env.MULMOCLAUDE_TRUSTED_ORIGINS), ...asCsv(process.env.ALLOWED_ORIGINS)],
