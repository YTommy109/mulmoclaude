...
const jaMessages = {
  ...
  pluginManageSkills: {
    ...
    sourceUserTitle: "User スキル (~/.claude/skills/、全ワークスペース共通)",
    sourceProjectTitle: "Project スキル (ワークスペース直下の .claude/skills/、このワークスペースのみ)",
    sourcePresetTitle: "プリセットカタログ — ★ Star でこのワークスペースに有効化",
