...
export const BUILT_IN_SERVER_BINDINGS: readonly ServerPluginBinding[] = [
  ...
  { def: presentDocumentDef, endpoint: API_ROUTES.plugins.presentDocument },
  { def: presentSpreadsheetDef, endpoint: API_ROUTES.plugins.presentSpreadsheet },
  { def: generateImageDef, endpoint: API_ROUTES.image.generate },
  { def: openCanvasDef, endpoint: API_ROUTES.plugins.canvas },
  { def: editImagesDef, endpoint: API_ROUTES.image.edit },
  { def: presentFormDef, endpoint: API_ROUTES.plugins.form },
